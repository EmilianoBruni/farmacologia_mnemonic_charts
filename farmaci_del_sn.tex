		...
		[.diretti
			[.{attivano recettori} 
				[.{esteri della colina} 
					...
					metacolina
					carbacolo
					\node[farmaco](beta){\index{betanecolo}};
				]
				[.alcaloidi
					[.muscarinici
						muscarina
						\node[farmaco]{\index{pilocarpina}};
					]
					[.nitotinici \node[farmaco]{\index{nicotina}}; ]				
				]
			]
		]
		[.indiretti
...
\begin{scope}[yshift=-14em]
	...
	[.\node(AchEIa){inibitori AchE};
		[.{alcool+gruppo N quaternario}
			[.\node[farmaco]{\index{edrofonio}}; 
				[.{legame idrogeno\\ o ionico con AchE} {idrolisi in minuti}
				]
			]
		]
		[.carbammati 
			[.\node[farmaco]{\index{neostigmina}\\ \index{fisostigmina}\footnotemark}; 
				[.{legame covalente con AchE} {idrolisi in ore}
				]
			]
		]
		[.organofosfati
			[.\node[farmaco](ecotiopato){\index{ecotipato}\footnotemark};
...
\begin{tikzpicture}
	...
	\Tree
	[.{usi clinici}
		[.\node[farmaco](pilocarpina){\index{pilocarpina}};
			[.{xerostomia da\\ sindrome di Sjogren} {$\uparrow$secrezioni salivali}
			]
		]
		[.\node[farmaco](ecotiopato){\index{ecotiopato}};
		...
		[.\node[farmaco](fisostigmina){\index{fisostigmina}};
...
\begin{tikzpicture}
	...
	[.{antagonisti\\ colinergici}
		[.antimuscarinici 
			[.\node[farmaco]{\index{atropina}}; {deriva da Belladonna e\\ Datura Stramonium}
			]
			\node[farmaco]{\index{scopolamina}};
		]
		[.antinicotinici 
			[.{bloccanti gangli\\ ganglioplegici} \node[farmaco]{\index{trimetafano}}; 
			\node[farmaco]{\index{tossina botulina}};
			]
			[.{bloccanti neuromuscolari}
			]
		]
		[.{rigeneratori dell'AchE} \node[farmaco]{\index{pralidossima}\footnotemark};
		]
	]
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	\Tree
	[.{usi clinici} 
		[.\node[farmaco](atropina){\index{atropina}};
		...
		[.\node[farmaco]{\index{tiotropio}};
			\node(bpco){BPCO};
		]
		[.\node[farmaco]{\index{oxibutina}};
			{tenismo urinario}
		]
		[.\node[farmaco]{\index{pralidossina}};
...
\begin{tikzpicture}
	...
	[.{usi clinici}
		...
		[.\node[farmaco]{\index{tossina botulinica}};
	...
	[.{bloccanti\\ neuromuscolari}
		[.{non depolarizzanti}
			[.{impediscono l'accesso dell'Ach\\ sul recettore $\text M_M$}
				{tubocuranina\\ (curaro)}
				\node[farmaco]{\index{rocuronio}};
			]
		]
		[.depolarizzanti
			[.{eccesso di Ach o simile}
				\node[farmaco]{\index{succinilcolina}\\(2 Ach legate tra loro)};
			]
		]
	]
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	\Tree
	[.\node[dummyc]{}; 
		[.\node[farmaco]{\index{noradrenalina}}; \node[farmaco]{\index{adrenalina}};]
	]	
	\end{scope}				
...
\begin{tikzpicture}
	...
	\Tree
	[.{usi clinici\\(diretti)}
		[.\node[farmaco]{\index{adrenalina}\\($\alpha,\beta$)};
			[.vasocostrizione
		...
		[.\node[farmaco]{\index{fenilefrina}\\($\alpha_1$)};
			{$\downarrow$prurito}
			{esame retina (midriasi)}
			\node(congestione){$\downarrow$congestione mucose};
		]
		[.\node[farmaco](oxi){\index{oximetazolina}\\($\alpha_2$)};
		]
		[.\node[farmaco]{\index{clonidina}\\($\alpha_2$)};
...
\begin{tikzpicture}
	...
	[.{usi clinici}
		[.{non selettivi}
			[.\node[farmaco]{\index{fenossibenzamina}\\ \index{fentolamina}};
		...
		[.{$\alpha_1$}
			[.\node[farmaco]{\index{prazosina}};
				{antiipertensivo}
				{ritenzione urinaria\\ da iperplasia prosatic benigna}
			]
			[.\node[farmaco]{\index{labetalolo}}; {blocca principalmente i $\beta$.\\ Descritto in seguito}
			]
		]
...
\begin{tikzpicture}
	...
	[.{usi clinici}
		...
		[.\node[farmaco]{\index{metoprololo}\\ \index{atenololo}};
			{emicrania}
			{tremore muscolare}
			{stati d'ansia}
		]
		[.\node[farmaco]{\index{labetalolo}\\ \index{carvedilolo}\\(sono sia $\alpha$ che $\beta$};
			{feocromocitoma}
			{feoc. + scompenso + ipertensione}
		]
		[.\node[farmaco]{\index{timololo}}; 
			{glaucoma}
		]
	]
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	[.farmaci
		...
		[.antagonisti
			[.{recettore NMDA}
				[.\node[farmaco]{\index{memantina}};
					{malattie neurovegetative}
				]
				[.\node[farmaco]{\index{ketamina}};
					{anestetico dissociativo}
				]
			]
			[.{recettore glicina in NMDA}
				\node[farmaco]{\index{acido chinuretico}};
			]
			[.AMPA
...
\begin{tikzpicture}
	...
	[.farmaci
		...
		[.{\ce{GABA_b}}
			[.agonisti
				[.\node[farmaco]{\index{bacoflen}};
					{miorilassante usato\\ nella terapia del dolore}
				]
			]
			[.antagonisti
				[.\node[farmaco]{\index{saclofen}};
