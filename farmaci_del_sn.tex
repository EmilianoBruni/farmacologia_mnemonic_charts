...
\footnotetext{L'attiva sia gli $alpha$ che i $\beta_2$. Se si immette un $\alpha$-bloccante questo neutralizzerà l'effetto vasocostrittore dell'adrenalina lasciando la sola attivazione dei $\beta_2$ che quindi causer\`a una vasodilatazione da cui un azione inversa a quella usuale dell'adrenalina}
