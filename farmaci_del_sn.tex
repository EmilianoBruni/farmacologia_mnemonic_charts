...
\begin{tikzpicture}
	...
	[.Effetti
		[.SNP
			[.{$\uparrow$permeabilità\\ Na${}^+$, K${}^+$, Ca${}^{2+}$}
				[.depolarizzazione
...
\begin{scope}[yshift=-14em]
	...
	[.\node(AchEIa){inibitori AchE};
		...
		[.organofosfati
			[.\node[farmaco](ecotiopato){\index{ecotipato}ecotipato\footnotemark};
...
Nota: Mettere da qualche parte il tacrida che è un inibitore della colinesterasi che poi si ritrova come inibitori del citocromo P450.
...
\begin{tikzpicture}
	...
	[.{usi clinici}
		...
		[.\node[farmaco](edofonio){\index{edofonio}edofonio};
...
\begin{tikzpicture}
	...
	[.{antagonisti\\ colinergici}
		...
		[.antinicotinici 
			...
			\node[farmaco]{\index{tossina botulina}tossina botulina};
			]
...
\begin{tikzpicture}
	...
	[.{usi clinici} 
		...
		[.\node[farmaco]{\index{pralidossina}pralidossina};
