...
\begin{tikzpicture}
	...
	[.Simpaticolitici
		...
		[.{$\beta$--bloccanti}
			[.\node[farmaco]{\index{propranololo}propranololo}; {Usato in ipertensione, scompenso cardiaco, \\ aritmie, glaucoma. Produce $\downarrow$GC e renina. \\ Da affaticamento,$\downarrow$umore, insomnia, $\uparrow$glicemia, \\ alterazione assetto lipidico (i non ASI). \\ Interruzione improvvisa $\uparrow$infarto.} ]
		]		
...
\begin{tikzpicture}
	...
	[.{Simpaticolitici}
		[.{$\beta$--bloccanti}
			[.\node[farmaco]{\index{propranololo}propranololo\footnotemark}; {$\downarrow$GC, $\downarrow$PA, $\downarrow$consumo \ce{O2} micardico} ]
		]
	]
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	[.effetti
		...
		[.{miocardio}
			\node[farmaco]{\index{varapamil}varapamil\\ \index{diltiazem}diltiazem};
		]
		[.{muscolo scheletrico}
...
\begin{tikzpicture}
	...
	[.farmaci
		...
		[.\node[farmaco]{\index{captopril}captopril\\ \index{elanapril}elanapril (ACE inibitore)};
			{\dwa post--carico}
		]
