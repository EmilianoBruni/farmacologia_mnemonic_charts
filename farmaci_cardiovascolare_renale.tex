...
\begin{tikzpicture}
	\Tree
	[.usi
		[.\node[farmaco]{acetazolamide\\ inibitore AC};
		...
		[.\node[farmaco]{mannitolo\\ diuretico osmotico};
			[.{per os}
				{diarrea}
			]
			[.{per IV}
...
\begin{tikzpicture}
	\Tree
	[.usi
		\node[farmaco](s){furosemide};
		\node[farmaco]{acido etacrinico};
	]
...
\begin{tikzpicture}
	\Tree
	[.usi
		[.\node[farmaco](a){cloratiazide};
			{per parenterale}
		]
		[.\node[farmaco](b){idrocloratiazide};
			\node(os){per os};
		]
		\node[farmaco](c){metodazone};
	]
