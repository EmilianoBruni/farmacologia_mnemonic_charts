\chapter{Farmaci del sistema cardiovascolare e renale}
...
\begin{tikzpicture}
	...
	[.{Diuretici\\ (capitolo ah hoc)}
		[.{Diuretici dell'ansa} \node[farmaco]{\index{furosemide}furosemide}; ]
		[.{Inibitori del simporto\\ \ce{Na+}-\ce{Cl-}} \node[farmaco]{tiazidici}; ]
		[. {Risparmiatori di \ce{K+}} \node[farmaco]{\index{spironolattone}spironolattone}; ]
	]
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	[.Simpaticolitici
		[.{SNC}
			[.\node[farmaco]{\index{metildopa}metildopa}; {Inibitore dopa-carbossilasi\\ emergenza ipertensiva \\ Da sedazione, tossicit\`a epatica\\ coombs positivo} ]
			[.\node[farmaco]{\index{clonidina}clonidina}; {Agonista $\alpha_2$. $\downarrow$noradrenalina\\ Usato in gravidanza \\ Da sonnolenza, depressione\\ $\downarrow$libido, secchezza fauci } ]
		]		
		[.{$\beta$--bloccanti}
			[.\node[farmaco]{\index{propanololo}propanololo}; {Usato in ipertensione, scompenso cardiaco, \\ aritmie, glaucoma. Produce $\downarrow$GC e renina. \\ Da affaticamento,$\downarrow$umore, insomnia, $\uparrow$glicemia, \\ alterazione assetto lipidico (i non ASI). \\ Interruzione improvvisa $\uparrow$infarto.} ]
		]		
		[.{$\alpha$--agonisti} \node[farmaco]{\index{doxazosina}doxazosina}; ]
		[.{Bloccanti misti $\alpha$/$\beta$}
			[.\node[farmaco]{\index{labetalolo}labetalolo}; {ipertensione da feocromocitoma.\\ Da prurito intenso, $\downarrow$eiaculazione} ]
		]
	 ]
\end{tikzpicture}
	...
	[.{Vasodilatatori}
		[.{diretti}
			[.{prevalentemente\\ arteriosi}
				[.{Inibitori IP3} \node[farmaco]{\index{idralazina}idralazina\\ (non pi\`u usato)}; ]
				[.{\ce{Ca^{2+}} antagonisti}  \node[farmaco]{\index{nifedipina}nifedipina\footnotemark\\ (anche verapamil\\ e diltiazem\\ ma su cuore)}; ]
			]
			[.{arterovenosi} 
				[.{rilascio \ce{NO}} \node[farmaco]{\index{nitroprussiato}nitroprussiato\footnotemark\\ nitroglicerina}; ]
			]
		]
		[.{indiretti}
			[.{ACE inibitori}
				[.\node[farmaco]{\index{captopril}captopril\\ \index{enalapril}enalapril\\ \index{fosinopril}fosinopril}; {Dilata arteriole e grandi vene. \\$\downarrow$pre/post carico. \\ Non inficia riflesso barocettivo\\ ne secrezione di aldosterone. \\ $\uparrow$bradichinina da tosse secca\\ e edema angioneurotico.} ]
			]
			[.{Antagonisti AT--1}
...
\begin{tikzpicture}
	...
	[.{Vasodilatatori}
		[.Nitrati
			[.\node[farmaco]{\index{isosorbide mononitrato}isosorbide mononitrato}; {Duranta d'azione pi\`u lunga} ]
			[.\node[farmaco]{\index{nitroglicerina}nitroglicerina}; {Rilascio \ce{NO}, $\uparrow$cGMP, relax muscolatura lis.\\ Via sublinguale, transdermica, rapido assorbimento\\ grazie alla solubilit\`a lipidica}  ]	
		]
		[.{\ce{Ca^{2+}}  antagonisti}
			[.\node[farmaco]{\index{verapamil}verapamil\\ (\index{diidropiridine}diidropiridine)}; {$\downarrow$conduzione NSA. $\downarrow$ RVP} ]
			[.\node[farmaco]{\index{diltiazem}diltiazem}; {$\downarrow$conduzione NSA. $\downarrow$ RVP} ]
			[.\node[farmaco]{\index{nifedipina}nifedipina}; {$\updownarrow$conduzione NSA.  Possibile tachicardia riflessa\\ minori effetti cardiaci} ]
		]
	]
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	[.{Simpaticolitici}
		[.{$\beta$--bloccanti}
			[.\node[farmaco]{\index{propanololo}propanololo\footnotemark}; {$\downarrow$GC, $\downarrow$PA, $\downarrow$consumo \ce{O2} micardico} ]
		]
	]
\end{tikzpicture}
	...
	[.effetti
		[.{muscolo liscio}
			[.{arteriole + sensibili delle venule.\\ Quindi meno effetto di ipotensione ortostatica}
				\node[farmaco]{\index{nifedipina}nifedipina};
			]
		]
		[.{miocardio}
			\node[farmaco]{\index{verapamil}verapamil\\ \index{diltiazem}diltiazem};
		]
		[.{muscolo scheletrico}
...
\section{Insufficienza cardiaca}
...
\begin{tikzpicture}
	\Tree
	[.farmaci
		[.\node[farmaco]{\index{digitale}digitale/\index{digitale}digossina\\ (inotropo+)};
		...
		[.\node[farmaco]{\index{dobutamina}dobutamina\\ (agonista $\beta_1$ selett.)};
			{\upa GC}
			{\dwa pre--carico}
		]
		[.\node[farmaco]{\index{furosemide}furosemide\\ (diuretico)};
			{\dwa P.A.}
			{\dwa pre--carico}
		]
		[.\node[farmaco]{\index{captopril}captopril\\ \index{enalapril}enalapril (ACE inibitore)};
			{\dwa post--carico}
		]
		[.\node[farmaco]{\index{losartan}losartan (antagonista AT-1)};
			{\dwa post--carico}
		]
		[.\node[farmaco]{\index{carvedilolo}carvedilolo\\ \index{metoprololo}metoprololo ($\beta$--bloccanti)};
			{cronotopo-}
...
\begin{tikzpicture}
	...
	\Tree
	[.{effetti avversi}
		[.\node[farmaco]{\index{digitale}digitale/digossina\\ (a dosi elevate)};
			{\upa aritmie, tachicardia, extrasistole\\ torsione di punta, FV}
		]
	]
\end{tikzpicture}

\section{Aritmie Cardiache}
...
\begin{tikzpicture}
	...
	[.{fasi miocardio}
		...
		[.{3: ripolarizzazione \\($\sim$ -20mV)}
			[.{corrente \ce{K+} in uscita\\ ($I_{\mathrm K_R}+I_{\mathrm K_S}$)}
			]
		]
		[.{4: diastole \\($\sim$ -??mV)}
...
Periodo refrattario tra fase 0 e ripristino del canale \ce{Na+} utile a consentire il propagarsi di un nuovo PdA.
...
\begin{tikzpicture}
	...
	[.{classi farmaci\\ aritmici}
		...
		[.{non Vaughan Williams\\ V}
			{iperpolarizzazione per\\ attivazione canali $\mathrm I_{K_L}$}
		]
	]
\end{tikzpicture}
...
\begin{tikzpicture}
	...
	[.farmaci
		[.IA
			[.\node[farmaco]{\index{procainamide}procainamide\\ \index{amiodarone}amiodarone};
		...
		[.IB
			[.\node[farmaco]{\index{lidocaina}lidocaina};
				{\dwa PdA}
				{\upa periodo refrattario}			
			]
		]
		[.IC
			[.\node[farmaco]{\index{flecaimide}flecaimide};
				{\dwa PdA lieve}
			]
		]
		[.II
		...
		[.III
			[.\node[farmaco]{\index{amiodarone}amiodarone\\ \index{sotalolo}sotalolo};
				{come IA}
			]
		]
		[.IV
			[.\node[farmaco]{\index{verapamil}verapamil};
				{riduzione fase plateau\\ con rallent. conduzione}
				{\upa periodo refrattario}
			]
		]
		[.V
			[.\node[farmaco]{\index{adenosina}adenosina};
...
\begin{tikzpicture}
	...
	[.{usi clinici}
		[.\node{flutter};
			\node[farmaco](digossina){\index{digitale}digossina (???)};
		]
		...
		[.\node(tac){tachiaritmia sopraventr.\\ parossistica};
			\node[farmaco](sotalolo){\index{sotalolo}sotalolo (III)};
			\node[farmaco](adenosina){\index{adenosina}adenosina (V)};
		]
		...
		[.\node{tutte le aritmie};
			\node[farmaco](amiodarone){\index{amiodarone}amiodarone (III)};
		]
	]
...
\begin{tikzpicture}
	\Tree
	[.usi
		[.\node[farmaco]{\index{acetazolamide}acetazolamide\\ inibitore AC};
		...
		[.\node[farmaco]{\index{mannitolo}mannitolo\\ diuretico osmotico};
			[.{per os}
				{diarrea}
			]
			[.{per IV}
...
\subsection{Ansa di Henle (tratto discendente)}
...
\subsection{Ansa di Henle (tratto ascendente)}
...
\begin{tikzpicture}
	\Tree
	[.usi
		\node[farmaco](s){\index{furosemide}furosemide};
		\node[farmaco]{\index{acido etacrinico}acido etacrinico};
	]
...
\subsection{Tubulo contorto distale}
...
\begin{tikzpicture}
	\Tree
	[.usi
		[.\node[farmaco](a){\index{cloratiazide}cloratiazide};
			{per parenterale}
		]
		[.\node[farmaco](b){\index{idrocloratiazide}idrocloratiazide};
			\node(os){per os};
		]
		\node[farmaco](c){\index{metodazone}metodazone};
	]
