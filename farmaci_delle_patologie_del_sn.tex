...
I farmaci atipici danno meno effetti collaterali motori perchè bloccano selettivamente la via mesolimbica (della gratificazione) invede del nigro--striato. Impegnati quindi se i sintomi extrapiramidali dei tipici fossero problematici.
...
\begin{tikzpicture}
	...
	[.{teorie\\ fisiopatologiche}
		[.{teoria monoaminergica}
			[.\node[farmaco]{\index{noradrenalina}noradrenalina\\\index{serotonina}serotonina};
				[.\dwa depressione ]
				[.\upa {elevazione dell'umore} ]
			]
		]
		[.{teoria neutrofica}
